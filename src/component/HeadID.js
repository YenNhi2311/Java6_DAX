                        ...
                        <div className="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                            <div className="flex-fill">
                                <ul className="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                                    ...
                                    <li className="nav-item">
                                        <Link to="/chitiet" className="h3 text-decoration-none">About</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to="/history" className="h3 text-decoration-none">History</Link>
                                    </li>
                                </ul>
                            </div>
                            <div className="navbar align-self-center d-flex">
                                ...
                                <a className="nav-icon position-relative text-decoration-none" href="#">
                                    <Link to="/giohang" className="dropdown-item"><i className="fa fa-fw fa-cart-arrow-down text-dark mr-1" />
